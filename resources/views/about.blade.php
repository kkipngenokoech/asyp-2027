...
$meetTerry = [
    'title' => 'Rencontrer Terry',
    'image' => 'terry-image.webp',
    'paragraphs' => [
        'Bonjour, je m\'appelle Terry. Je travaille dans l\'industrie du tapis depuis 1982. Ma passion pour les tapis s\'est développée dès mes premiers pas dans ce métier fascinant. Au fil des années, j\'ai eu l\'opportunité de travailler avec des artisans talentueux et d\'apprendre les secrets de ce métier ancestral.',
        ...
        'Chez Terry\'s Rugs, nous sommes fiers d\'offrir à nos clients un excellent service, un grand choix de tapis, les meilleures ailes et l\'installation de rampes d\'escalier. Nous espérons que vous viendrez nous rendre visite bientôt et que vous profiterez pleinement de notre expertise. À bientôt !',
...
<div class="flex flex-col md:flex-row bg-white p-6 md:p-12 gap-8 md:gap-12">
    <div class="md:w-1/2">
        <img src="{{ asset('images/' . $meetTerry['image']) }}" 
             alt="Terry" 
    ...
    <div class="md:w-1/2 md:pl-10 flex flex-col justify-center space-y-4">
        ...
        @foreach($meetTerry['paragraphs'] as $paragraph)
...
<div class="bg-white p-6 md:p-12">
    ...
    <div class="flex flex-col md:flex-row items-center gap-6">
        <div class="md:w-1/2 md:text-justify">
            ...
            <p class="text-gray-700">
                {{ $meetTerry['paragraphs'][0] }}
            </p><br/>
            <p class="text-gray-700">
                {{ $meetTerry['paragraphs'][3] }}
            </p>
            <br/>
            <p class="text-gray-700">
                {{ $meetTerry['paragraphs'][3] }}
        ...
        <div class="md:w-1/2">
           <img src="{{ asset('images/kid-image.avif') }}" alt="Sitting Rugs" class="w-full h-96 object-contain object-top rounded-lg shadow-md">
        </div>
    </div>
    ...
    <div class="mt-10 space-y-8">
        ...
        <div class="relative h-[400px] group overflow-hidden rounded-lg shadow-[0_15px_25px_rgba(0,0,0,0.2)] hover:shadow-[0_20px_30px_rgba(0,0,0,0.2)] transition-all duration-300">
            <img src="{{ asset('images/rug-on-wall.jpg') }}" alt="Our Mission" 
        ...
        <div class="relative h-[400px] group overflow-hidden rounded-lg shadow-[0_10px_20px_rgba(0,0,0,0.15)] hover:shadow-[0_20px_30px_rgba(0,0,0,0.2)] transition-all duration-300">
            <img src="{{ asset('images/white-rugs.jpg') }}" alt="Vision" 
                class="w-full h-full object-cover transition-all duration-300 brightness-[0.6] group-hover:brightness-[0.3]">
            <div class="absolute inset-0 p-8 flex flex-col justify-center opacity-80 group-hover:opacity-100 transition-opacity duration-300">
                <h3 class="text-3xl font-bold text-white mb-4">Vision</h3>
                <p class="text-white text-lg leading-relaxed">
                    {{ $meetTerry['paragraphs'][2] }}
                </p>
            </div>
        </div>
    </div>
