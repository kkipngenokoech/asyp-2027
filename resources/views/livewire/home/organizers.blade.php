                ...
                @foreach ($organizers as $index => $organizer)
                    <div class="bg-white rounded-xl shadow-sm overflow-hidden border border-gray-100 hover:shadow-md transition duration-200">
                        ...
                        <div class="p-6">
                            ...
                            <p class="text-blue-600 font-medium mb-2">{{ $organizer['role'] }}</p>
                            <p class="text-gray-600 mb-4">{{ $organizer['description'] }}</p>
                            ...
                            <div class="flex flex-wrap gap-2">
                                ...
                                @isset($organizer['social']['github'])
                                    <a href="{{ $organizer['social']['github'] }}" class="inline-flex items-center px-3 py-1.5 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-lg text-sm transition">
                                        <svg class="w-4 h-4 mr-1.5" fill="currentColor" viewBox="0 0 24 24">
